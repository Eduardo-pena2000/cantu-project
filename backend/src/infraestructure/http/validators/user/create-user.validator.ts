...
const createUser: ValidationChain[] = [
  body("names")
    .notEmpty()
    .withMessage("El campo 'names' es obligatorio.")
    .isString()
    .withMessage("El campo 'names' debe ser un texto."),
  body("last_names")
    .notEmpty()
    .withMessage("El campo 'last_names' es obligatorio.")
    .isString()
    .withMessage("El campo 'last_names' debe ser un texto."),
  body("phone")
    .notEmpty()
  ...
  body("roles")
    .notEmpty()
    .withMessage("El campo 'roles' es obligatorio.")
...
export const createUserValidator = new ValidatorMiddleware(createUser);
