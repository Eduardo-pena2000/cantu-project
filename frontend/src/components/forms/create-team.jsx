...
import { createTeamSchema, defaultValues } from "@/schemas/team";
...
export function CreateTeamForm({ onFormSubmit, className }) {
  ...
  async function onSubmit(values) {
    ...
    if (res.error) {
      toast.error(res.error.message, { id: "create-team" });
      throw res.error.message;
    }

    toast.success(res.message, { id: "create-team" });
