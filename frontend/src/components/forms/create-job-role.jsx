...
import { createJobRole } from "@/actions/job-roles";
import { createJobRoleSchema, defaultValues } from "@/schemas/job-role";
...
export function CreateJobRoleForm({ onFormSubmit, className }) {
  ...
  async function onSubmit(values) {
    const res = await createJobRole(values);
    ...
    if (res.error) {
      toast.error(res.error.message, { id: "create-job-role" });
      throw res.error.message;
    }

    toast.success(res.message, { id: "create-job-role" });
