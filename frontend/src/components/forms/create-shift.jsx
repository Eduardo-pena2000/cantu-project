...
import { createShiftSchema, defaultValues } from "@/schemas/shift";
...
export function CreateShiftForm({ onFormSubmit, className }) {
  ...
  async function onSubmit({ name, manager_id, temporal_manager, schedules }) {
    ...
    if (res.error) {
      toast.error(res.error.message, { id: "create-shift" });
      throw res.error.message;
    }

    toast.success(res.message, { id: "create-shift" });
